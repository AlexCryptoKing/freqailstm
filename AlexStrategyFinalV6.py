...
class ExampleLSTMStrategy(IStrategy):
    ...
    # Hyperspace parameters:
    buy_params = {
      "threshold_buy": -0.4484260699971744,
      "w0": 0.7167683337777161,
      "w1": 0.8634961703833423,
      "w2": 0.32697613121497565,
      "w3": 0.43255515681465606,
      "w4": 0.6185156691904744,
      "w5": 0.20368714855867348,
      "w6": 0.06571565592006524,
      "w7": 0.03626232822155618,
      "w8": 0.2625916287907824
    }

    sell_params = {
        "threshold_sell": -0.34204103367837535,
      "s0": 0.32122808191164226,
      "s1": 0.33618498328637975,
      "s2": 0.9566030255461531,
      "s3": 0.2762600506447435,
      "s4": 0.7480887750005146,
      "s5": 0.9799822902316113,
      "s6": 0.45773209440054186,
      "s7": 0.4330838388604582,
      "s8": 0.5070853203011013,
    ...
    s0 = RealParameter(0, 1, default=0.10, space='sell')
    s1 = RealParameter(0, 1, default=0.15, space='sell')
    s2 = RealParameter(0, 1, default=0.10, space='sell')
    s3 = RealParameter(0, 1, default=0.15, space='sell')
    s4 = RealParameter(0, 1, default=0.10, space='sell')
    s5 = RealParameter(0, 1, default=0.10, space='sell')
    s6 = RealParameter(0, 1, default=0.10, space='sell')
    s7 = RealParameter(0, 1, default=0.05, space='sell')
    s8 = RealParameter(0, 1, default=0.15, space='sell')
    ...
    def set_freqai_targets(self, dataframe: DataFrame, metadata: Dict, **kwargs) -> DataFrame:
        ...
        s = [self.s0.value, self.s1.value, self.s2.value, self.s3.value, self.s4.value, self.s5.value, self.s6.value, self.s7.value, self.s8.value]
        ...
        dataframe['V'] = 1 / (dataframe['bb_upperband'] - dataframe['bb_lowerband']).replace(0, np.nan)
        ...
        target_horizon = 5  # Define your prediction horizon here
