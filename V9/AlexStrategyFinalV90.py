...
freqtrade trade --strategy AlexStrategyFinalV89Hyper --config config-torch.json --freqaimodel PyTorchLSTMRegressor
freqtrade backtesting --breakdown day week --cache none -c config-torch.json --timerange 20240209-20240220


freqtrade backtesting --strategy AlexStrategyFinalV9 -c config-torch.json --freqaimodel PyTorchLSTMRegressor --timerange 20240801-20240820
freqtrade backtesting --strategy AlexStrategyFinalV9 -c config-torch.json --freqaimodel XGBoostRegressor --breakdown day week month   --timerange 20240801-20240810

freqtrade lookahead-analysis --strategy AlexStrategyFinalV9 -c config-torch.json --timerange 20240101-20240820
